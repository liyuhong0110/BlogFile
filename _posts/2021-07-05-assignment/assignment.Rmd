...
Desafio Golf Course seemed to be a popular locations for GASTech employees to relax in weekends, but too many employees went here at the same time in the weekend just before the event of disappear.
...
GPS path map showed that many employeew went to Alberts Fine Clothing after they completed the meeting at the white house, especially in the weekend days of 18 and 19. Though they probably made an appointment to go shopping together, but it was still very abnormal that several employees went to together. At the same time, Alberts Fine Clothing was an extremely popular locations among all the locations because almost every employees have the records of stopping and shopping here, though this clothing shop was far from GASTech. 

![](images\13.png)

## 8.4 Roberts and Son'
It was also a very popular locations for employees to meet, but we didn't make accurate justification about the function or type of this shop from its name.
