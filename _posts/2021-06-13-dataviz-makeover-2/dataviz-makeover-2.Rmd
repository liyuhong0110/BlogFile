...
1) **Clear and interactive title**: The main title "Singapore's Merchandise Trade Value with Trading Partners, (Period)" shows the purpose of the visulisation and provides an interactive part of "(Period)" which will change as the reader's choice.
...
3) **Simple and clear layout**: Delete the unnecessary part of the visualisation, and adjust the layout of the visualisation.
...
8. Adjust the Format of all the values as the following figures.
